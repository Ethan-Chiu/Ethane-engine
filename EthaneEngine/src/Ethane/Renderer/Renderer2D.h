...
namespace Ethane {
	...
	public:
		...
		static void DrawTexture(const glm::mat4& transform, Texture2DRendererComponent& src, int entityID);
		static void DrawTexture(const glm::mat4& transform, SubTexture2DRendererComponent& src, int entityID);
