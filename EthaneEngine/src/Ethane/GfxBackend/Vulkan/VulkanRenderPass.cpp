...
namespace Ethane {
    ...
    VulkanRenderPass::VulkanRenderPass(const VulkanDevice* device, const std::vector<ImageFormat>& colorAttachmentFormats, ImageFormat depthAttachmentFormat, bool clearOnLoad, bool finalPresent)
        :m_Device(device)
    {   
